...
export async function generateWorkAgreement(tender: E_tender, officeAddress: OfficeAddress | null): Promise<Uint8Array> {
    ...
    let agreementDateForHeading = '____________________';
    ...
    const drawBoxLine = (label: string, value: string) => {
        firstPage.drawText(label, { x: paddingX, y: boxTextY, font: timesRomanBoldFont, size: 8.5, color: rgb(0.2, 0.2, 0.2) });
    ...
    drawBoxLine("PERFORMANCE GUARANTEE:", "................................");
    drawBoxLine("ADDITIONAL PERFORMANCE GUARANTEE:", "................................");
